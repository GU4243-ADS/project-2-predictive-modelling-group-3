...
#img_test_dir   <- paste(experiment_dir, "test/", sep="") # we don't have a training dataset yet -- (SB)
```
...
```{r SIFT features}
## having trouble on this section
# sift_feature_dir <- "../data/train-features/" # This will be modified for different data sets.
# img_sift_dir  <- paste(sift_feature_dir, sep="")
# 
# train_SIFT<- readRDS('../data/training.RData')
