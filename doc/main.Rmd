...
```{r model_setup}
model_values <- seq(3, 11, 2) # trying a few different depths 
...
Maybe we think that the row right where the bottom of the 9's circle starts might be darker for the 9 than the 7. 
```{r}
...
# # reads in all the image files, calculates row means, stores all info in matrix. Now we have labels 1 or 0 for 7 or 9 in a 16 dimensional space. 
# tm_feature_train <- NA
