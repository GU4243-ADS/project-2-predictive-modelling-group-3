...
write.csv(pred_random,"pred_random.csv")
write.csv(pred_svm,"pred_svm.csv")
write.csv(pred_lr,"pred_lr.csv")
write.csv(pred_combined,"pred_combined.csv")
