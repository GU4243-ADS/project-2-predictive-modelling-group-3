...
#val 
#load("../output/randomforestmodel_final.rda") # called rf

#testingfinal

pred_random <- predict(rf, SIFTHOG_val)
pred_random  = as.numeric(pred_random) - 1
error_rate_random <- mean(pred_random != val_labels)
...
load("../output/logisticregression_SIFT+HOG_2000.rda") #logistic.fit.1500

testdata = SIFTHOG_val
logistic_pred <- predict(logistic.fit.1500, newdata = SIFTHOG_val, "response")
